...
class SearchEngine extends Controller
{
    ...
    {
    	$book = DB::table('books')->select('books.title','books.id')->join('authors_books','authors_books.book_id','=','books.id')->join('authors','authors.id','=','authors_books.author_id')->get();
        $category = Category::all();
        $author = DB::table('authors')->select('authors.id','authors.surname','authors.name')->join('authors_books','authors_books.author_id','=','authors.id')->join('books','books.id','=','authors_books.book_id')->get();
