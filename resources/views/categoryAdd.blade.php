                ...
                <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <form method='post' action="{{('/categoryAdd')}}">
                                        {{ csrf_field() }}
                                        <label> nazwa:    </label> <input type="text" name="category" class="form-control"/>  <br/>
                                    </br>
                                ...
                                @foreach($category as $c)
                                 <tr>
                                    ...
                                    <td>{{ $c->id }}</td>
                                    <td>{{ $c->category }}
                                    <a href="{{ route('editCategory',['id' => $c->id]) }}">Edytuj</a> / 
                                    <a href="{{ route('deleteCategory', ['id' => $c->id]) }}">Usun</a> </td>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
