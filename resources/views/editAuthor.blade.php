    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="register">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Edytowanie autorów </h2>
                <!-- Icon Divider-->
                <div class="ml-12">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm xl">
                                <form method='post' action="{{ route('updateAuthor') }}">
                                        ...
                                        <label class="posesTag"> imie:    </label> <input type="text" name="name" value="{{ $edit->name }}" class="form-control devolt"/>  <br/>
                                        <label class="posesTag"> nazwisko:    </label> <input type="text" name="surname" value="{{ $edit->surname }}" class="form-control devolt"/>  <br/>
                                    </br>
                                    <input type="submit" name="edycja" class="btn btn-primary btn-xl-lite" value="zapisz"/>
                                    <a class="btn btn-primary btn-xl-lite" href="{{ url('/authorAdd') }}">Cofnij</a>
                                </form>
